...
reliable as possible. As soon as the $H_\alpha$ mock will be available we also
plan to run the void finding procedure on that catalog. The $H_\alpha$ catalog
...
\item {\bf Emission line separation.} On high redshift, the primary target will
...
\item {\bf Galaxy cluster modeling. }\Oli{Heidi: Please add a few (5-10) lines and references about cluster simulation and modeling.}

\item {\bf Systematics mitigation at the likelihood level.} \Oli{Tim: Please add a few (5-10) lines and reference about systematics in \CoLi !}
